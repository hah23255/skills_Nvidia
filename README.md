...
| **Medical AI Skills** | Agent-ready medical AI skills built on MONAI for DICOM handling, NVIDIA-hosted medical imaging model workflows, segmentation, synthesis, and evidence-oriented evaluation. | [`dicom-metadata-extract`](skills/dicom-metadata-extract), [`dicom-series-preflight`](skills/dicom-series-preflight), [`dicom-series-to-volume`](skills/dicom-series-to-volume), [`medtech-model-evidence-export`](skills/medtech-model-evidence-export), [`nv-generate-ct-rflow`](skills/nv-generate-ct-rflow), [`nv-generate-mr`](skills/nv-generate-mr), [`nv-generate-mr-brain`](skills/nv-generate-mr-brain), [`nv-generate-mr-brain-finetune`](skills/nv-generate-mr-brain-finetune), [`nv-generate-vae-finetune`](skills/nv-generate-vae-finetune), [`nv-reason-cxr`](skills/nv-reason-cxr), [`nv-segment-ct`](skills/nv-segment-ct), [`nv-segment-ct-finetune`](skills/nv-segment-ct-finetune), [`nv-segment-ctmr`](skills/nv-segment-ctmr) |
...
| **Physical AI Augmentation** | Author, validate, and run Physical AI Data Factory augmentation pipelines for image and video generation and transformation. | [`paidf-augmentation`](skills/paidf-augmentation) |
| **Physical AI Auto-Labeling** | Build and run Physical AI Data Factory auto-labeling pipelines for video enhancement, tracking, captioning, and question generation. | [`paidf-auto-labeling`](skills/paidf-auto-labeling) |
| **Physical AI Curation and Retrieval** | Author, validate, and run Physical AI Data Factory curation and retrieval pipelines. | [`paidf-curation-and-retrieval`](skills/paidf-curation-and-retrieval) |
| **Physical AI Orchestration** | Build, run and monitor physical AI data factory pipelines for image and video generation and transformation. | [`paidf-orchestration-write-dag`](skills/paidf-orchestration-write-dag), [`paidf-orchestration-setup`](skills/paidf-orchestration-setup), [`physical-ai-event-video-generation`](skills/physical-ai-event-video-generation), [`physical-ai-image-attribute-augmentation`](skills/physical-ai-image-attribute-augmentation) |
...
| **Physical AI Augmentation** | [Issues](https://github.com/NVIDIA/paidf-augmentation/issues) | — | [Contributing](https://github.com/NVIDIA/paidf-augmentation/blob/main/CONTRIBUTING.md) | [Security](https://github.com/NVIDIA/paidf-augmentation/blob/main/SECURITY.md) |
| **Physical AI Auto-Labeling** | [Issues](https://github.com/NVIDIA/paidf-auto-labeling/issues) | — | [Contributing](https://github.com/NVIDIA/paidf-auto-labeling/blob/main/CONTRIBUTING.md) | [Security](https://github.com/NVIDIA/paidf-auto-labeling/blob/main/SECURITY.md) |
| **Physical AI Curation and Retrieval** | [Issues](https://github.com/NVIDIA/paidf-curation-and-retrieval/issues) | — | [Contributing](https://github.com/NVIDIA/paidf-curation-and-retrieval/blob/main/CONTRIBUTING.md) | [Security](https://github.com/NVIDIA/paidf-curation-and-retrieval/blob/main/SECURITY.md) |
| **Physical AI Orchestration** | [Issues](https://github.com/NVIDIA/paidf-orchestration/issues) | — | [Contributing](https://github.com/NVIDIA/paidf-orchestration/blob/main/CONTRIBUTING.md) | [Security](https://github.com/NVIDIA/paidf-orchestration/blob/main/SECURITY.md) |
